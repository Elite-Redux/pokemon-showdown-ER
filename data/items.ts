export const Items: { [itemid: string]: ItemData } = {
	...
	abomasite: {
		...
		onTakeItem(item, source) {
			...
			if (item.megaStone === source.baseSpecies.name) return false;
			return true;
		},
		num: 674,
		gen: 6,
	...
	houndoominiter: {
		...
		spritenum: 591,
		megaStone: "Houndoom-Mega-Redux",
		megaEvolves: "Houndoom-Redux",
		itemUser: ["Houndoom-Redux"],
		onTakeItem(item, source) {
			if (item.megaEvolves === source.baseSpecies.name) return false;
			if (item.megaStone === source.baseSpecies.name) return false;
			return true;
	...
	tyranitariter: {
		name: "Tyranitarite-R",
		spritenum: 607,
		megaStone: "Tyranitar-Mega-Redux",
