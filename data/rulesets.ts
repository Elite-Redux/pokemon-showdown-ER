...
export const Rulesets: { [k: string]: FormatData } = {
	...
	monotypeabilitybanlist: {
		effectType: "ValidatorRule",
		name: "Monotype Ability Banlist",
		desc: "Ability banlist for monotype",
		banlist: [
			"ability:inverseroom",
			"Electro Surge",
			"Psychic Surge",
	...
	cheapblowclause: {
		...
		onValidateTeam(team) {
			...
			if (count > 1) {
				return [`You may only have up to 1 Pokemon with Cheap Tactics or Low Blow. Your team currently has ${count}.`];
			}
		},
	},
