...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standarddoubles: {
		...
		ruleset: [
			'Obtainable', 'Team Preview', 'Sleep Cause Mod', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Gravity Sleep Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod',
			'Min Source Gen = 9',
		],
	},
	standardoms: {
