export const AbilitiesText: { [k: string]: AbilityText } = {
	...
	flowergift: {
		name: "Flower Gift",
		desc: "While Sun is active Special Attack and Special Defense of it and its allies are multiplied by 1.5. Additionally, Cherrim will transform into Cherrim Sunshine.",
		shortDesc:
			"When Sun is active, it and allies' Sp. Atk and Sp. Def are 1.5x.",
		gen7: {
	...
	powerofalchemy: {
		...
		desc: "On entry, transforms the foe's item into Black Sludge. If it's already holding a Black Sludge it transforms that into a Big Nugget.",
		shortDesc: "On entry turns the opposing item to Black Sludge or a Big Nugget.",
		gen8: {
